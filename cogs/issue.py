...
class issue(commands.Cog):
    ...
    async def on_ready(self):
        ...
        logging.info("---|Issue      cog loaded!|---  %s", current_time())
    ...
    async def ping(self, ctx: commands.Context):
        ...
        Issue_embed.add_field(name="Github issues:", value= "https://github.com/Local-Drug-Lord/The-Holy-Roller-bot-V1/issues/new/choose[https://github.com/Local-Drug-Lord/The-Holy-Roller-bot-V1/issues/new/choose]", inline=False)
